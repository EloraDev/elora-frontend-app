...
import { QueryProviders, type getQueryClient } from '../providers/query.provider';
...
function RootComponent() {
  return (
    <main className="flex min-h-screen flex-col w-full" role="main" aria-label="Main application layout">
      <QueryProviders>
